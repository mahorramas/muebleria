<nav class="mt-4">
    <ul class="flex flex-col gap-2">
        ...
        <li class="px-2 flex flex-col gap-2" x-data="{ open: false }">
            ...
            <ul class="flex flex-col gap-2" name="sub-salas" x-cloak x-show="open"
        ...
        <li x-data="{ open: {{ request()->routeIs('salas.*') ? 'true' : 'false' }} }">
            <button type="button" @click="open = !open">Salas</button>
